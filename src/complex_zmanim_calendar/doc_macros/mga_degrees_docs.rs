macro_rules! shaah_mga_degrees_basedon_doc {
    ($degrees:expr, $minutes:expr) => {
        concat!(
            ...
            to *tzeis*. This day is split into 12 equal parts with each part being
...
macro_rules! slmk_mga_degrees_doc {
    ($degrees:expr) => {
        concat!(
            ...
            to the *Magen Avraham* based on *alos* and *tzeis* being ",
            stringify!($degrees),
...
macro_rules! mk_mga_degrees_doc {
    ($degrees:expr) => {
        concat!(
            ...
            Avraham* based on *alos* and *tzeis* being ",
            stringify!($degrees),
